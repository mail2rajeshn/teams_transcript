...
st.markdown("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.")
    st.markdown("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=False)
    st.markdown("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=true)
    st.title("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.")
    st.title("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=False)
    st.title("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=true)
    st.text("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.")
    st.text("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=False)
    st.text("The group is discussing the design of a clinical product, specifically the representation of the fulfillment process and labs in the model. They debate whether these should be entities or attributes and if labs should be represented as objects. The design choices are important for effective implementation and require careful consideration.\n\nKey takeaways:\n1. The design of a clinical product requires careful consideration of representation choices.\n2. The fulfillment process and labs are important components to consider in the model.\n3. Design choices may be debated, but ultimately need to be carefully considered for effective implementation.\n4. The representation of labs as objects may be a point of discussion.\n5. The decision to represent fulfillment process as an entity or attribute may also be debated.",unsafe_allow_html=true)
